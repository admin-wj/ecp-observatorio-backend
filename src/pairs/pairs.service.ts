...
export class PairsService {
  ...
  async findAffinityData(filters: Filters): Promise<PairsAffinityResponse> {
    ...
    const dataByPairsAndDimension = calculateGroupedMetrics(
      rawData,
    ...
    const dataInTimeByAffinity = getDataInTime(
      rawData,
      filters.extraFilters[PairsAffinityEnum.Pair],
      PairsAffinityEnum.Pair,
    );

    const dataInTimeByTexts = getDataInTime(
      rawData,
      filters.extraFilters[PairsAffinityEnum.Pair] || [],
      PairsAffinityEnum.Pair,
      'count',
    ...
    const dataByPairs = calculateAffinityMetricsByGroups(
      rawData,
      PairsAffinityEnum.Pair,
      PairsAffinityEnum.Dimension,
      filters.extraFilters[PairsAffinityEnum.Pair] || [],
